				...
				<tr class="shipping_desc">
					...
					<td align="left">
					   <select name="linksynceparcel[method]" style="width:200px">
                            ...
                            ?>
							<option value="<?php echo $method; ?>" <?php if (LinksynceparcelHelper::getFormValue('method', $type->method) == $method){ echo 'selected="selected"'; }?>>
				...
				<tr>
                    ...
                    <td align="left">
                     	<select name="linksynceparcel[charge_code]" style="width:200px">
							...
							?>
							<option value="<?php echo $chargeCode['Name']?>" <?php if (LinksynceparcelHelper::getFormValue('charge_code', $type->charge_code) == $chargeCode['Name']){ echo 'selected="selected"'; }?>>
