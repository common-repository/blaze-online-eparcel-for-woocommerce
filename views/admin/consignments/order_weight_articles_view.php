...
<div class="entry-edit wp-core-ui single-create-consignment order_weight_articles" id="eparcel_sales_order_view">
	...
	<!-- /end -->
	    ...
	    <input type="hidden" id="overallweight" value="<?php echo $weight; ?>"/>
	    <input type="hidden" id="exactArticles" value="<?php echo $exactArticles; ?>"/>
	    <input type="hidden" id="totalArticles" value="<?php echo $totalArticles; ?>"/>
	    <input type="hidden" id="reminderWeight" value="<?php echo $reminderWeight; ?>"/>
		...
		<?php
         ...
         ?>
    	<input id="consignment_weight_article_submit2" type="submit" name="createConsignment" value="Create Consignment" class="button-primary button create-consignment1 scalable save submit-button <?php if($order_status == 'completed'){ echo 'disabled';}?>" <?php if($order_status == 'completed'){ echo 'disabled="disabled"';}?>/>
...
<div id="custom_articles" style="display:none">
    ...
    &nbsp;&nbsp;
    <input id="consignment_weight_article_submit" type="submit" name="createConsignment"  value="Create Consignment" class="button-primary button scalable save submit-button <?php if($order_status == 'completed'){ echo 'disabled';}?>" <?php if($order_status == 'completed'){ echo 'disabled="disabled"';}?>/>
