...
if(!class_exists('LinksynceparcelAdminMenu2'))
{
	class LinksynceparcelAdminMenu2
	{
		public static function output($obj)
		{
			...
			{
				$main_page = add_menu_page( __('eParcel Consignment View', 'linksynceparcel'),__('Blaze Online eParcel', 'linksynceparcel'), 'shop_manager', 'linksynceparcel', array(&$obj,'consignments'), linksynceparcel_URL.'assets/images/logo-blaze.png', '55.6' );
			...
			{
				 $main_page = add_menu_page( __('eParcel Consignment View', 'linksynceparcel'),__('Blaze Online eParcel', 'linksynceparcel'), 'administrator', 'linksynceparcel', array(&$obj,'consignments'), linksynceparcel_URL.'assets/images/logo-blaze.png', '55.6' );
				$linksynceparcel_consignment_menu = $main_page;
